...
$query = "SELECT * FROM successful_payment_master WHERE id='$id'";
...
<div id="invoice">
    ...
    <div class="toolbar hidden-print">
        ...
        <div class="text-right">
            ...
            <button onclick="myFunction()" id="printInvoice" class="btn btn-info"><i class="fa fa-print"></i>Click to Print</button>
            ...
            <header>
                ...
                <div class="row">
                    ...
                    <div class="col company-details">
                        ...
                        <div>68 Molade Okoya Thomas, Off Ajose Adeogun <br> Street, Victoria Island.</div>

                        <div>+234 708 194 8647</div>
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tbody>
                          ...
                          <tr>
                            ...
                            <td class="text-left"><h3>Certified NDP Master Course </h3></td>
