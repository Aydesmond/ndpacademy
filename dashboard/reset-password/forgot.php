<?php
    ...
    if (isset($_POST['email'])) {
        ...
        require_once '../include/db.php';      // Include database config
        require_once '../include/config.php';  // Include our config file
      ...
      A link to reset your password has been sent to ' . $email . ',please check your Inbox or spam folder. </div>';
