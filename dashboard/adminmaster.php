...
<table class='table'>
   ...
   <?php
    ...
    $result2 = mysqli_query($db, "SELECT * FROM successful_payment_master ORDER BY id DESC");
...
<button class="btn btn-primary mt-4" name="paid">Submit</button> <hr>
...
if (isset($_POST['paid'])) {
  ...
  // Finally, register user if there are no errors in the form
  	...
  	$query = "INSERT INTO successful_payment_master (email, amount_paid, course_id, receipt_number) 
